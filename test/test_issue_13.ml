...
let%test "test_constant_int_if_true3" = test_typecheck
  "contract C {
      ...
      int y = 2;
int z =2;
      function f(int y) public { x = z* (y/ x); }
}"
true
